...
```bash
# Update bead with test progress
bd update <issue-id> --add-note="Tests: [X/Y] passing, [Z] failing"

# Add detailed results
bd update <issue-id> --add-note="Test summary: [coverage]%, [duration]s"

# Sync state
bd sync
```

**Note**: Do NOT close beads. Report test results and let the code-reviewer close on final approval.
