...
interface SurveyFormBaseProps {
    ...
    onExtraData?: () => Record<string, unknown> | null; // Get extra data from type-specific fields
}
...
export default function SurveyFormBase({
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const extraData = onExtraData ? onExtraData() : undefined;

        // If validation failed in child form, don't submit
        if (onExtraData && extraData === null) {
            return;
        }
        ...
        const formData: SurveyFormData = {
            ...
            surveyData: extraData ?? undefined,
        };
            ...
            <div className={styles.formGrid}>
                ...
                <div className={`${styles.formGroup} ${styles.fullWidth}`}>
                    ...
                    <textarea
                        ...
                        placeholder="e.g., Zillow, Realtor.com, Referrals, Facebook groups..."
                        rows={2}
                    />
                </div>
