          ...
          >
            <div>
              ...
              >
                ...
                <option value="lead_purchase">Lead Purchases</option>
              ...
              <div style={{ textAlign: 'right' }}>
                ...
                <div
                  style={{
                    ...
                    borderRadius: '4px',
                    backgroundColor:
                      tx.status === 'completed' ? '#d1fae5' : tx.status === 'pending' ? '#fef3c7' : '#fee2e2',
                    color:
                      tx.status === 'completed' ? '#065f46' : tx.status === 'pending' ? '#92400e' : '#991b1b',
