    ...
    <div style={{ display: 'flex', height: 'calc(100vh - 64px)', background: 'white' }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ flex: 1, padding: '20px' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            <div style={{ alignSelf: 'flex-start', maxWidth: '60%' }}>
              <Skeleton width={200} height={48} variant="rectangular" />
            </div>
            <div style={{ alignSelf: 'flex-end', maxWidth: '60%' }}>
              <Skeleton width={180} height={48} variant="rectangular" />
            </div>
            <div style={{ alignSelf: 'flex-start', maxWidth: '60%' }}>
              <Skeleton width={250} height={64} variant="rectangular" />
            </div>
            <div style={{ alignSelf: 'flex-end', maxWidth: '60%' }}>
              <Skeleton width={150} height={48} variant="rectangular" />
            </div>
          </div>
        </div>
        ...
        >
          ...
          <Skeleton width={80} height={48} variant="rectangular" />
        </div>
      </div>
    </div>
  )
