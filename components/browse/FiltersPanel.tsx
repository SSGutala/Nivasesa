        ...
        <div className={styles.overlay} onClick={onClose}>
            <div className={styles.panel} onClick={e => e.stopPropagation()}>
                ...
                <div className={styles.content}>
                    ...
                    <div className={styles.section}>
                        <h3>Languages</h3>
                        <input type="text" placeholder="Search languages..." className={styles.searchInput} />
                    </div>

                    <div className={styles.section}>
                        <h3>Pets</h3>
                        <div className={styles.options}>
                            <label className={styles.radio}><input type="radio" name="pets" /> Pets allowed</label>
                            <label className={styles.radio}><input type="radio" name="pets" /> No pets</label>
                        </div>
                    </div>
                    ...
                    <div className={styles.section}>
                        <h3>Smoking</h3>
                        <div className={styles.options}>
                            <label className={styles.radio}><input type="radio" name="smoking" /> Smoking-free</label>
                            <label className={styles.radio}><input type="radio" name="smoking" /> Allowed</label>
                        </div>
                    </div>
                </div>
